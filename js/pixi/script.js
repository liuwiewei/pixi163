...
function init(){
    ...
    $(".uploadBtn").on("click",function(){
        ...
        neteaseTracker(false,'http://minisite.click.163.com/2018/0120/taidu/uploadBtn', '跳转上传页按钮', 'minisiteclick');
        setTimeout(function(){
            window.location.href = "http://go.163.com/2018/0120/taidu-upload/index.html";
        },250);
